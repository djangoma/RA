...
#return ', '.join(map(str,book.facultyauthor.all().values('facultyname')))
	...
	class Meta:
		model = BookSeries
		fields = ('id','refformat', 'facultyauthor', 'booktitle', 'bookname', 'pubfromconf', 'bsjr', 'bsnip', 'bisbn', 'created_at', 'updated_at', 'created_by', 'updated_by')
		import_id_fields = ['id']
...
class ProjectResource(resources.ModelResource):
	facultypi = fields.Field(column_name='facultypi', widget=ManyToManyWidget(Faculty,'facultyname'))
	facultycopi = fields.Field(column_name='facultycopi', widget=ManyToManyWidget(Faculty,'facultyname'))
	student = fields.Field(column_name='student', widget=ManyToManyWidget(Student,'sname'))
	rs = fields.Field(column_name='rs',widget=ManyToManyWidget(ResearchScholar, 'rsname'))
	#facultyauthor = fields.Field(column_name='facultyauthor', attribute='facultyauthor.set()', widget=ManyToManyWidget(Faculty,))
	#fa = display_fauthor()
	#facultynames = fields.Field()
